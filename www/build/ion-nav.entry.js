import { r as registerInstance, k as createEvent, i as Build, h, m as getElement } from './index-1837c15a.js';
import { g as getIonMode, c as config } from './ionic-global-3c553627.js';
import { b as assert } from './helpers-2774d300.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-448cee6c.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await __sc_import_app('./swipe-back-b4d041ee.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
